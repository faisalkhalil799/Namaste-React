...
const Header = () => {
  return (
    <header className="header-container">
      <div className="logo">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0wQaCqfNqSSf5ivSTfLQPx0FbMEBzYQt0bg&s"
          alt="App Logo"
        />
      </div>
...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-2d802320-c00f-4309-8449-f2828c5892b0",
    },
    cta: {
  ...
  },
  {
    ...
    info: {
      ...
      sla: {
        ...
        lastMileTravel: 13.7,
        serviceability: "SERVICEABLE",
        slaString: "74-84 mins",
        lastMileTravelString: "13.7 km",
        iconType: "ICON_TYPE_EMPTY",
      },
      availability: {
        nextCloseTime: "2025-12-30 11:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    ...
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2025/9/27/58dd1b8b-b6cd-4097-a58b-d00860032807_1219882.jpg",
    ...
    cta: {
      link: "https://www.swiggy.com/city/chhindwara/monginis-cake-shop-chhindwara-city-rest1219882",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    ...
    info: {
      ...
      availability: {
        nextCloseTime: "2025-12-30 22:30:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    ...
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2025/9/20/0d0484a5-84e2-4c8c-8b17-c6d66bd4b8fa_1211230.jpg",
      locality: "Chhindwara City",
      areaName: "Chhindwara City",
      ...
      availability: {
        nextCloseTime: "2025-12-30 15:00:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  return (
    <div className="body-container">
      {resList.map((restaurant) => (
        <FoodItem key={restaurant.info.id} {...restaurant.info} />
      ))}
    </div>
  );
};
